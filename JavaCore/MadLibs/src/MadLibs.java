...
public class MadLibs {
	...
	/* Print instruction to player */
	public void printInstructions() {
		System.out.println(
				"Welcome to MadLibs game. If you type in" + "words, we'll give you a story. Start by typing in a name");
	}
	...
	public void enterAjective1() {
		System.out.println("Give me a adjective!");
		setAdjective1(scanner.nextLine());
	}

	public void enterAjective2() {
		System.out.println("Give me a ajective!");
	...
	public void putTogetherTheStory() {
		...
		if(num == 0) {
		Story = "Jesse and her best firend "+getName()+" went to Disney World today! They saw a "+
	getNoun1()+" in a show at the Magic Kindom and ate a "+getAdjective1()+" feast for dinner. "+
	"The next day I ran "+getAdverb() + " to meet Mickey Mouse in his "+getNoun2()+" "+
	"and then that night I gazed at the "+getRandomNums()+" "+getAdjective2()+" fireworks"+
	" shooting from the "+getNoun3()+"."; }
		else {
		...
		+getAdjective2()+ " apes yelled in their faces, making "+" Amanda and "+getName()+" sprint all the way back home.";
		}
		setStory(Story);
	}
